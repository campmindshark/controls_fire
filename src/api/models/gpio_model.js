...
export default class gpio {
  constructor(id, mode, init_value) {
    ...
    , "power"].map(
      ...
      static master_power_pin = 71;
      static gpio_pins = [30,31,48,5 ,3 ,49,117,115,111,110,20 ,60,50,51,4 ,2 ,15,14 ,113,112,7
        ,38,34,66,69,45,23,47 ,27 ,22 ,62 ,36,32,86,87,10,9 ,8 ,78,76,74,72,70
        ,39,35,67,68,44,26,46 ,65 ,63 ,37 ,33,61,88,89,11,81,80,79,77,75,73];
        //#endregion
      //#region Properties
        get Value() {
